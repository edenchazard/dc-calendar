export default defineNuxtPlugin(() => {
  if (!Intl.supportedValuesOf) {
    ...
    Intl.supportedValuesOf = function (
      key: Parameters<typeof Intl.supportedValuesOf>[0],
    ): string[] {
      switch (key) {
        case 'timeZone':
    ...
    // With modifications from eden chazard.
    // Polyfill Intl.getSupportedTimeZones
    function getSupportedTimeZones() {
      ...
      return TIMEZONES_IN_CLDR.filter(isSupported);
    }
  }
});
